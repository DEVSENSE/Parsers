...
namespace gpcc
{
    public class CodeGenerator
    {
        ...
        private string GenerateValueType()
        {
            if (this.grammar.unionType != null)
            {
                this.output.WriteLine("{0}\n{1} partial struct {2}",
                    string.IsNullOrEmpty(this.grammar.ValueTypeAttributes) ? "" : string.Format("[{0}]", this.grammar.ValueTypeAttributes),
                    this.grammar.Visibility,
                    this.grammar.ValueTypeName);
        ...
        private void GenerateClassHeader(string name)
        {
            ...
            this.output.WriteLine("{0}\n{1} partial class {2}: ShiftReduceParser<{3},{4}>", new object[]
            {
                string.IsNullOrEmpty(this.grammar.Attributes)? "": string.Format("[{0}]", this.grammar.Attributes),
                this.grammar.Visibility,
                name,
                text,
