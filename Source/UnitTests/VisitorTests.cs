...
namespace UnitTests
{
    ...
    public class VisitorTests
    {
        ...
        sealed class AstCounterFactory : BasicNodesFactory
        {
            ...
            public override LangElement If(ConditionalStmt conditions)
                 => CountLE(base.If(conditions));
            ...
            public override FormalParam Parameter(Span span, VariableNameRef name, TypeRef typeOpt, FormalParam.Flags flags, Expression initValue, PhpMemberAttributes visibility, List<LangElement> property_hooks)
                 => (FormalParam)CountLE(base.Parameter(span, name, typeOpt, flags, initValue, visibility, property_hooks)); // TODO - replace definitions by interfaces
