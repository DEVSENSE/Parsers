...
namespace UnitTests
{
    ...
    public class VisitorTests
    {
        ...
        sealed class AstCounterFactory : BasicNodesFactory
        {
            ...
            public override LangElement List(Span span, IEnumerable<ArrayItem> targets, bool isOldNotation)
            ...
            public override LangElement New(Span span, TypeRef classNameRef, IList<ActualParam> argsOpt, Span argsSpan)
