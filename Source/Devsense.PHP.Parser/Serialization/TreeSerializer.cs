    ...
    public class TreeSerializer : TreeVisitor
    {
        ...
        override public void VisitDirectFcnCall(DirectFcnCall x)
        {
            _serializer.StartSerialize(typeof(DirectFcnCall).Name, SerializeSpan(x.Span),
                new NodeObj("Name", x.FullName.Name.ToString()), new NodeObj("OriginalName", x.FullName.OriginalName.ToString()), new NodeObj("FallbackQualifiedName", x.FullName.FallbackName.ToString()));
        ...
        override public void VisitGlobalConstUse(GlobalConstUse x)
        {
            _serializer.StartSerialize(typeof(GlobalConstUse).Name, SerializeSpan(x.Span),
                new NodeObj("Name", x.Name.ToString()), new NodeObj("OriginalName", x.FullName.OriginalName.ToString()), new NodeObj("FallbackName", x.FallbackName.ToString()));
        ...
        override public void VisitPHPDocStmt(PHPDocStmt x)
        {
            _serializer.StartSerialize(typeof(PHPDocStmt).Name, SerializeSpan(x.Span));
            SerializePHPDoc(x.PHPDoc);
