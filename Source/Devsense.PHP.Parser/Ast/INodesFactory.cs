...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public interface INodesFactory<TNode, TSpan> : IDocBlockFactory<TSpan>
    {
        ...
        /// <param name="property_hooks">Optional. Property hooks, see <see cref="PropertyHookDecl"/>.</param>
        FormalParam Parameter(TSpan span, VariableNameRef name, TypeRef typeOpt, FormalParam.Flags flags = FormalParam.Flags.Default, Expression initValue = null,
            PhpMemberAttributes visibility = 0,
            List<TNode> property_hooks = null
        );
        ...
        TNode TraitAdaptationPrecedence(TSpan span, Tuple<TypeRef, NameRef> name, IEnumerable<TypeRef> precedences);
        ...
        TNode TraitAdaptationAlias(TSpan span, Tuple<TypeRef, NameRef> name, NameRef identifierOpt, PhpMemberAttributes? attributeOpt);
        ...
        TNode ExpressionStmt(TSpan span, TNode expression);
        ...
        TNode Static(TSpan span, IEnumerable<TNode> staticVariables);
        ...
        TNode StaticVarDecl(TSpan span, VariableName name, TNode initializerOpt);
        ...
        /// </summary>
        TNode If(ConditionalStmt conditions);
        ...
        /// <returns>Type node.</returns>
        TypeRef AnonymousTypeReference(TSpan span, TSpan headingSpan,
            bool conditional, PhpMemberAttributes attributes,
