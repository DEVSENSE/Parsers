...
namespace PHP.Syntax
{
    ...
    public abstract class ErrorSink
    {
        ...
        internal void Add(ErrorInfo info, SourceUnit sourceUnit, Span pos)
        {
            Add(info, CoreResources.GetString(info.MessageId), sourceUnit, pos);
        }

        internal void Add(ErrorInfo info, SourceUnit sourceUnit, Span pos, params string[] args)
        {
        ...
        private void Add(ErrorInfo info, string/*!*/ message, SourceUnit sourceUnit, Span pos)
        {
