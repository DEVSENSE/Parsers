...
{
public enum Tokens {ERROR=127,EOF=128,T_INCLUDE=129,T_INCLUDE_ONCE=130,T_EVAL=131,T_REQUIRE=132,T_REQUIRE_ONCE=133,T_LOGICAL_OR=134,T_LOGICAL_XOR=135,T_LOGICAL_AND=136,T_PRINT=137,T_YIELD=138,T_DOUBLE_ARROW=139,T_YIELD_FROM=140,T_PLUS_EQUAL=141,T_MINUS_EQUAL=142,T_MUL_EQUAL=143,T_DIV_EQUAL=144,T_CONCAT_EQUAL=145,T_MOD_EQUAL=146,T_AND_EQUAL=147,T_OR_EQUAL=148,T_XOR_EQUAL=149,T_SL_EQUAL=150,T_SR_EQUAL=151,T_POW_EQUAL=152,T_COALESCE=153,T_BOOLEAN_OR=154,T_BOOLEAN_AND=155,T_IS_EQUAL=156,T_IS_NOT_EQUAL=157,T_IS_IDENTICAL=158,T_IS_NOT_IDENTICAL=159,T_SPACESHIP=160,T_IS_SMALLER_OR_EQUAL=161,T_IS_GREATER_OR_EQUAL=162,T_SL=163,T_SR=164,T_INSTANCEOF=165,T_INC=166,T_DEC=167,T_INT_CAST=168,T_DOUBLE_CAST=169,T_STRING_CAST=170,T_ARRAY_CAST=171,T_OBJECT_CAST=172,T_BOOL_CAST=173,T_UNSET_CAST=174,T_POW=175,T_NEW=176,T_CLONE=177,T_NOELSE=178,T_ELSEIF=179,T_ELSE=180,T_ENDIF=181,T_STATIC=182,T_ABSTRACT=183,T_FINAL=184,T_PRIVATE=185,T_PROTECTED=186,T_PUBLIC=187,T_LNUMBER=188,T_DNUMBER=189,T_STRING=190,T_VARIABLE=191,T_INLINE_HTML=192,T_ENCAPSED_AND_WHITESPACE=193,T_CONSTANT_ENCAPSED_STRING=194,T_STRING_VARNAME=195,T_NUM_STRING=196,END=197,T_EXIT=198,T_IF=199,T_ECHO=200,T_DO=201,T_WHILE=202,T_ENDWHILE=203,T_FOR=204,T_ENDFOR=205,T_FOREACH=206,T_ENDFOREACH=207,T_DECLARE=208,T_ENDDECLARE=209,T_AS=210,T_SWITCH=211,T_ENDSWITCH=212,T_CASE=213,T_DEFAULT=214,T_BREAK=215,T_CONTINUE=216,T_GOTO=217,T_FUNCTION=218,T_CONST=219,T_RETURN=220,T_TRY=221,T_CATCH=222,T_FINALLY=223,T_THROW=224,T_USE=225,T_INSTEADOF=226,T_GLOBAL=227,T_VAR=228,T_UNSET=229,T_ISSET=230,T_EMPTY=231,T_HALT_COMPILER=232,T_CLASS=233,T_TRAIT=234,T_INTERFACE=235,T_EXTENDS=236,T_IMPLEMENTS=237,T_OBJECT_OPERATOR=238,T_LIST=239,T_ARRAY=240,T_CALLABLE=241,T_LINE=242,T_FILE=243,T_DIR=244,T_CLASS_C=245,T_TRAIT_C=246,T_METHOD_C=247,T_FUNC_C=248,T_COMMENT=249,T_DOC_COMMENT=250,T_OPEN_TAG=251,T_OPEN_TAG_WITH_ECHO=252,T_CLOSE_TAG=253,T_WHITESPACE=254,T_START_HEREDOC=255,T_END_HEREDOC=256,T_DOLLAR_OPEN_CURLY_BRACES=257,T_CURLY_OPEN=258,T_PAAMAYIM_NEKUDOTAYIM=259,T_NAMESPACE=260,T_NS_C=261,T_NS_SEPARATOR=262,T_ELLIPSIS=263,T_ERROR=264};
...
#line 261 "C:\Users\Michal\Projects\Parsers\Source\PhpParser\Generators\PhpParser.y"
