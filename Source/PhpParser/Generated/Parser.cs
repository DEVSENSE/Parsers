...
{
public enum Tokens {T_INCLUDE=127,T_INCLUDE_ONCE=128,T_EVAL=129,T_REQUIRE=130,T_REQUIRE_ONCE=131,T_LOGICAL_OR=132,T_LOGICAL_XOR=133,T_LOGICAL_AND=134,T_PRINT=135,T_YIELD=136,T_DOUBLE_ARROW=137,T_YIELD_FROM=138,T_PLUS_EQUAL=139,T_MINUS_EQUAL=140,T_MUL_EQUAL=141,T_DIV_EQUAL=142,T_CONCAT_EQUAL=143,T_MOD_EQUAL=144,T_AND_EQUAL=145,T_OR_EQUAL=146,T_XOR_EQUAL=147,T_SL_EQUAL=148,T_SR_EQUAL=149,T_POW_EQUAL=150,T_COALESCE=151,T_BOOLEAN_OR=152,T_BOOLEAN_AND=153,T_IS_EQUAL=154,T_IS_NOT_EQUAL=155,T_IS_IDENTICAL=156,T_IS_NOT_IDENTICAL=157,T_SPACESHIP=158,T_IS_SMALLER_OR_EQUAL=159,T_IS_GREATER_OR_EQUAL=160,T_SL=161,T_SR=162,T_INSTANCEOF=163,T_INC=164,T_DEC=165,T_INT_CAST=166,T_DOUBLE_CAST=167,T_STRING_CAST=168,T_ARRAY_CAST=169,T_OBJECT_CAST=170,T_BOOL_CAST=171,T_UNSET_CAST=172,T_POW=173,T_NEW=174,T_CLONE=175,T_NOELSE=176,T_ELSEIF=177,T_ELSE=178,T_ENDIF=179,T_STATIC=180,T_ABSTRACT=181,T_FINAL=182,T_PRIVATE=183,T_PROTECTED=184,T_PUBLIC=185,T_LNUMBER=186,T_DNUMBER=187,T_STRING=188,T_VARIABLE=189,T_INLINE_HTML=190,T_ENCAPSED_AND_WHITESPACE=191,T_CONSTANT_ENCAPSED_STRING=192,T_STRING_VARNAME=193,T_NUM_STRING=194,T_EXCLAM=33,T_DOUBLE_QUOTES=34,T_DOLLAR=36,T_PERCENT=37,T_AMP=38,T_LPAREN=40,T_RPAREN=41,T_MUL=42,T_PLUS=43,T_COMMA=44,T_MINUS=45,T_DOT=46,T_SLASH=47,T_COLON=58,T_SEMI=59,T_LT=60,T_EQ=61,T_GT=62,T_QUESTION=63,T_AT=64,T_LBRACKET=91,T_RBRACKET=93,T_CARET=94,T_BACKQUOTE=96,T_LBRACE=123,T_PIPE=124,T_RBRACE=125,T_TILDE=126,END=0,T_EXIT=224,T_IF=225,T_ECHO=226,T_DO=227,T_WHILE=228,T_ENDWHILE=229,T_FOR=230,T_ENDFOR=231,T_FOREACH=232,T_ENDFOREACH=233,T_DECLARE=234,T_ENDDECLARE=235,T_AS=236,T_SWITCH=237,T_ENDSWITCH=238,T_CASE=239,T_DEFAULT=240,T_BREAK=241,T_CONTINUE=242,T_GOTO=243,T_FUNCTION=244,T_CONST=245,T_RETURN=246,T_TRY=247,T_CATCH=248,T_FINALLY=249,T_THROW=250,T_USE=251,T_INSTEADOF=252,T_GLOBAL=253,T_VAR=254,T_UNSET=255,T_ISSET=256,T_EMPTY=257,T_HALT_COMPILER=258,T_CLASS=259,T_TRAIT=260,T_INTERFACE=261,T_EXTENDS=262,T_IMPLEMENTS=263,T_OBJECT_OPERATOR=264,T_LIST=265,T_ARRAY=266,T_CALLABLE=267,T_LINE=268,T_FILE=269,T_DIR=270,T_CLASS_C=271,T_TRAIT_C=272,T_METHOD_C=273,T_FUNC_C=274,T_COMMENT=275,T_DOC_COMMENT=276,T_OPEN_TAG=277,T_OPEN_TAG_WITH_ECHO=278,T_CLOSE_TAG=279,T_WHITESPACE=280,T_START_HEREDOC=281,T_END_HEREDOC=282,T_DOLLAR_OPEN_CURLY_BRACES=283,T_CURLY_OPEN=284,T_PAAMAYIM_NEKUDOTAYIM=285,T_NAMESPACE=286,T_NS_C=287,T_NS_SEPARATOR=288,T_ELLIPSIS=289,T_ERROR=290,EOF=291};
