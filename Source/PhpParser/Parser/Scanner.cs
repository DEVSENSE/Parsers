...
namespace PhpParser.Parser
{
    ...
    {
        void OnLineComment(Scanner/*!*/scanner, TextSpan span);
        void OnComment(Scanner/*!*/scanner, TextSpan span);
        void OnPhpDocComment(Scanner/*!*/scanner, PHPDocBlock phpDocBlock);

        void OnOpenTag(Scanner/*!*/scanner, TextSpan span);
        void OnCloseTag(Scanner/*!*/scanner, TextSpan span);
    }
    ...
    public sealed class Scanner : Lexer, ITokenProvider<SemanticValueType, Span>
    {
        ...
        internal sealed class NullCommentsSink : ICommentsSink
        {
            ...
            public void OnLineComment(Scanner scanner, TextSpan span) { }
            public void OnComment(Scanner scanner, TextSpan span) { }
            public void OnPhpDocComment(Scanner scanner, PHPDocBlock phpDocBlock) { }
            public void OnOpenTag(Scanner scanner, TextSpan span) { }
            public void OnCloseTag(Scanner scanner, TextSpan span) { }
        ...
        private TextSpan TokenTextSpan { get { return new TextSpan(sourceUnit, tokenPosition); } }
        ...
        SemanticValueType ITokenProvider<SemanticValueType, Span>.TokenValue
        {
            get { return tokenSemantics; }
        }

        Span ITokenProvider<SemanticValueType, Span>.TokenPosition
        {
